...
export default function EditTransactionPage(props: any) {
  ...
  useEffect(() => {
    // In a real app, you would fetch the transaction by ID
    ...
    if (transaction.recurring) {
      setIsRecurring(true)
      setRecurringData(transaction.recurring as any)
    }
  }, [props?.params?.id])
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1 min-w-0">
                <h1 className="text-2xl lg:text-3xl font-bold tracking-tight truncate">Edit Transaction</h1>
                <p className="text-sm lg:text-base text-muted-foreground">Update your transaction details</p>
              </div>
            </div>
